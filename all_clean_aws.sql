...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `BeforeSketch_To_AfterSketch`(jobRefNo Varchar(30)) RETURNS int(11)
BEGIN
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `deleteUsers`(user_id int) RETURNS int(11)
BEGIN
  DECLARE l_return INT DEFAULT  0;
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `generateId`(idName Varchar(50)) RETURNS int(11)
BEGIN
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `global_profile_change_mapping_attrs`(mappingType varchar(10),existingVal Varchar(9999), newVal Varchar(9999), existingDesc varchar(9999), newDesc varchar(9999)) RETURNS varchar(1100) CHARSET utf8
BEGIN
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `global_profile_change_question`(pageCode varchar(10),mainQuestion Varchar(200), existingSubQtn varchar(200), newSubQtn varchar(200) ) RETURNS varchar(100) CHARSET utf8
BEGIN   
                DECLARE done INTEGER DEFAULT 0;
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `newDiagram`(jobFerNo Varchar(50),decision Varchar(1)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `populateAfterSketch`(jobFerNo Varchar(50)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
  DECLARE l_jobRefNo Varchar(50);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
  DECLARE l_return INT DEFAULT  0; 
  DECLARE l_status INT DEFAULT  5; 
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `populateBeforeSketch`(jobFerNo Varchar(50)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                DECLARE l_jobRefNo Varchar(50);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
                DECLARE l_return INT DEFAULT  0; 
                DECLARE l_status INT DEFAULT  5; 
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `updateStatus`(jobFerNo Varchar(50),decision char(1)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                DECLARE l_jobRefNo Varchar(50);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
                DECLARE l_return INT DEFAULT  0; 
                DECLARE l_status INT DEFAULT  5; 
...
/*!50003 CREATE DEFINER=`jobCraftingTool` FUNCTION `update_facilitator_type_after_chk_realization`(headerId int(11), customerId Varchar(100), createdBy Varchar(100)) RETURNS int(11)
BEGIN
                DECLARE l_return INT DEFAULT  0;
...
/*!50003 CREATE DEFINER=`jobCraftingTool` PROCEDURE `BeforeSketch_To_AfterSketch`(IN jobRefNo Varchar(30))
BEGIN
  DECLARE l_jobRefNo Varchar(30);
  DECLARE l_jct_bs_task_id Int;
  DECLARE l_jct_bs_energy Int;
...
/*!50003 CREATE DEFINER=`jobCraftingTool` PROCEDURE `createUser`(userNo INT(10), userType INT(1))
BEGIN
