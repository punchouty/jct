	            ...
	            <form class="form-horizontal main_div" name="bulkAction" autocomplete="on" novalidate enctype="multipart/form-data" data-remote="true"> 	            
                 ...
                 <!--  User Group -->
                  <div class="single_form_item">
                     ...
                     <%-- <div class="col-sm-6">
                     	<input id="userGroupInptId" class="form-control-general-form-redefined disable_style" type="text" value="<spring:message code="label.default.user.group"/>" maxlength="60" disabled="true"></input>
                     </div>  --%>
                     <div class="col-sm-5">
                   	<select class="form-control-general" id="userGroupInptId"  onchange="openRadioDiv()">
...
<script src="../js/bulkActionFacilitator.js"></script>
