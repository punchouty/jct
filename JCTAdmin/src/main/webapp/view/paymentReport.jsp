	        ...
	        <div class="row">  
	            ...
	            <div class= "heading_label">
	            	<ol class="breadcrumbAdmin">
           				...
           				<li class="second_nav"><spring:message code="label.payment.report"/></li>
             		</ol>
	            </div>
	            <div class= "sub_contain"><spring:message code="label.payment.report"/></div>
	            
	            <div class= "main_contain">	  
	             <div class="form_area_top">
	             <div class= "inner_container"><spring:message code="label.payment.report"/></div> 
                    ...
                    <div class="single_form_item">
                     ...
                     <div class="col-sm-5">
                     	<select class="form-control-general" id="inptUserType">
                     		...
                     		<option class="form-control-general" value="0"><spring:message code="label.user.type.select.drpDwn.all"/> </option>
                ...
                <div class="single_form_item">
                    <p><a id='generateXL' href='#' class="btn_admin btn_admin-primary btn_admin-sm search_btn cstm-text-format" onclick='generateExcel(event)'>Generate Excel</a></p>
                </div>	                
	             </form>
	           </div>
