	...
	<body>
	    ...
	    <!-- Header area end --> 	       
	        <div class="row">  
	            ...
	            <div class= "main_contain main_contain_ipad">
	            ...
	            <div class="single_form_item">
                     <div class="col-sm-4 ">
                     <label for="inputFN" class="col-sm-12 control-label text_label"><spring:message code="label.user.profile"/></label></div>
                     <div class="col-sm-5">                   	
                     	<input id="inputUserProfileInpt" class="form-control-general-form-redefined disable_style" type="text" value="Default Profile" disabled="true"></input>
                     </div> 
	            ...
	            <div class="single_form_item">
                   ...
                   <div class="col-sm-5"><input type="text" class="form-control-general-form-redefined" maxlength="50" value=""  placeholder="User Group Name" id="userGroupInptId" onkeypress="return alphaNumericOnly(event)" autofocus></div> 
                   <div class="col-sm-2">&nbsp;</div>  
                   <div class="clearfix"></div>
                </div>
                 <div class="single_form_item">
                   <p><input type="button" class="btn_admin btn_admin-primary btn_admin-sm search_btn" value="Create" id="createUserGroupBtnId" onclick="saveUserGroup()" />
                   <input type="button" class="btn_admin btn_admin-primary btn_admin-sm search_btn btn_admin_reset" value="Reset" id="createUserGroupResetId" onclick="resetUserGroup()" style="display:none" />
                   </p>
                 </div>
                </div>
...
<script src="../js/facilitatorUserGroup.js"></script>
