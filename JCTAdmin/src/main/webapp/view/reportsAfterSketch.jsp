...
<html>
<head>
    <title><spring:message code="label.reportAfterSketch" /></title>
	        ...
	        <div class="row">  
	            ...
	            <div class= "heading_label">
	            	<ol class="breadcrumbAdmin">
           				...
           				<li class="second_nav"><spring:message code="reports.breadcrumb.bs.as"/></li>
             		</ol>
	            </div>
	            <div class= "sub_contain"><spring:message code="label.afterSketchRprt"/></div>
	            
	            <div class= "main_contain">	  
	             <div class="form_area_top" style="display: none;">
	             <div class= "inner_container"><spring:message code="label.searchAfterSketchRprt"/></div> 
	            ...
	            <!-- FUNCTION GROUP -->
                 ...
                 <!-- JOB LEVEL -->
                   ...
                   <div class="single_form_item">
                     <p><input type="button" class="btn_admin btn_admin-primary btn_admin-sm search_btn" value="Search Report" id="searchBtnAS" onclick="populateAfterSketchSelectedReport('newid')" /></p>
                   </div>	                
	             </form>
	             </div>
	             ...
	             <div>	            
	              <div class="col-sm-7 result_text" id="afterSketchResultDiv"><spring:message code="label.resultAfterSketchRprt"/></div>  
	              <div class="col-sm-4 inner_container" id="genearteXLDiv"></div>  
	             </div>
	              <div>
	              <div class="col-sm-6 display_value pd-l-7" id="afterSketchRptHdrDiv"></div>
	              <div class="col-sm-5"></div>
	              <div class="clearfix"></div> 
	              </div>
	              </div>
	          
	             <div class="main_div table_contant report_scroll pd-r-0" >
	              	 <div id="afterSketchRptDiv"></div>
	              	 <div id="afterSketchRptMappingDtlDiv" style="display: none;"></div>
	             </div> 
	            </div>	            
...
<script src="../js/afterSketchReport.js"></script>
