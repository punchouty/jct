...
<html>
<head>
    <title><spring:message code="label.grp.pro.rpt" /></title>
	        ...
	        <div class="row">  
	            ...
	            <div class= "heading_label">
	            	<ol class="breadcrumbAdmin">
           				...
           				<li class="second_nav"><spring:message code="reports.breadcrumb.bs.gp"/></li>
             		</ol>
	            </div>
	            <div class= "sub_contain"><spring:message code="menu.reports.group.profile"/></div>
	            
	            <div class= "main_contain">	  
	             <div class="form_area_top">
	             <div class= "inner_container"><spring:message code="label.searchGroupProfileRprt"/></div> 
	            ...
	            <br>
                    <div class="single_form_item">
                     ...
                     <div class="col-sm-5">
                     	<select class="form-control-general" id="inputUserProfileInpt">
                   ...
                   <div class="single_form_item">
                     <!-- <p><input type="button" class="btn_admin btn_admin-primary btn_admin-sm search_btn" value="Generate Excel" id="generateXL" onclick="generateXLReport()" /></p> -->
...
<script src="../js/groupProfileReport.js"></script>
