...
<html>
<head>
    <title><spring:message code="label.reportActionPlan" /></title>
	           ...
	           <!--  <div class="col-sm-12 container container_mid" > -->
	            ...
	            <div class= "heading_label">
	            	<ol class="breadcrumbAdmin">
           				...
           				<li class="second_nav"><spring:message code="reports.breadcrumb.bs.ap"/></li>
             		</ol>
	            </div>
	            
	            <div class= "sub_contain"><spring:message code="label.actionPlanRprt"/></div>
	            
	            <div class= "main_contain">	  
	             <div class="form_area_top" style="display: none;">
	             <div class= "inner_container"><spring:message code="label.searchActionPlanRprt"/></div> 
	            ...
	            <!-- FUNCTION GROUP -->
                 ...
                 <!-- JOB LEVEL -->
                   ...
                   <div class="single_form_item">
                     <p><input type="button" class="btn_admin btn_admin-primary btn_admin-sm search_btn" value="Search Report" id="searchBtnAP" onclick="populateActionPlanSelectedReport('newid')" /></p>
                   </div>	
	             ...
	             <div class="result_area">	            
	              <div class="col-sm-7 result_text" id="actionPlanResultDiv"><spring:message code="label.resultActionPlanRprt"/></div>  
	              <div class="col-sm-4 inner_container" id="genearteXLDiv"></div>  	              
	              <div class="clearfix"></div> 
	              
	              
	              <div class="col-sm-6 display_value pd-l-7" id="actionPlanRptHdrDiv"></div>
	              <div class="col-sm-5"></div>
	              <div class="clearfix"></div> 
	              </div>
  
	             <div class="main_div table_contant report_scroll pd-r-0" >
	              	 <div id="actionPlanRptDiv"></div>
	             </div>   
	            </div>	            
...
<script src="../js/actionPlanReport.js"></script>
