...
<html>
<head>
    <title><spring:message code="label.reportBeforeSketch" /></title>
	           ...
	           <!--  <div class="col-sm-12 container container_mid" > -->
	            ...
	            <div class= "heading_label">
	            	<ol class="breadcrumbAdmin">
           				...
           				<li class="second_nav"><spring:message code="reports.breadcrumb.bs.bs"/></li>
             		</ol>
	            </div>
	            <div class= "sub_contain"><spring:message code="label.beforeSketchRprt"/></div>
	            
	            <div class= "main_contain">	  	            
	             <div class="form_area_top" style="display: none;">
	             <div class= "inner_container"><spring:message code="label.searchBeforeSketchRprt"/></div> 
	            ...
	            <div class="single_form_item">
	               ...
	               <!-- No function Group and Job Level -->
	               <!-- FUNCTION GROUP -->
                   <%-- <div class="single_form_item">
                     <div class="col-sm-4 ">
                   ...
                   <div class="single_form_item">
                     <p><input type="button" class="btn_admin btn_admin-primary btn_admin-sm search_btn" value="Search Report" id="searchBtnBS" onclick="populateBeforeSketchSelectedReport('newid')" /></p>
                   </div>
	            ...
	            <div>           
	              <div class="col-sm-7 result_text" id="beforeSketchResultDiv"><spring:message code="label.resultBeforeSketchRprt"/></div>  
	              <div class="col-sm-4 inner_container" id="genearteXLDiv"></div>  
	             </div>  
	             <div>  	              
	              <div class="col-sm-6 display_value pd-l-7" id="beforeSketchRptHdrDiv"></div>
...
<script src="../js/bootstrap.min.js"></script>
<script src="../js/beforeSketchReport.js"></script>
