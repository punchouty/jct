...
(function ($) {
    ...
    Filestyle.prototype = {
        ...
        constructor: function () {
            ...
            html = '<div for="'+id+'" class="col-md-8" style="padding-left:0px;">'+this.htmlInput()+'</div>'+
                 '<div class="col-md-4"><label for="'+id+'" class="'+this.options.classButton+'">'+
                    this.htmlIcon()+
