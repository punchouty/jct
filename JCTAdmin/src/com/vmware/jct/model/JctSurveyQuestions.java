...
@NamedQueries({
	@NamedQuery(name = "getSurveyUserIdAndCount",
		query = "Select DISTINCT new com.vmware.jct.dao.dto.SurveyQuestionDTO( COUNT(sq.jctSurveyTakenByUserId), sq.jctSurveyTakenByUserId) " +
				"from JctSurveyQuestions sq, JctUser u "+
				"where u.jctUserId = sq.jctSurveyTakenByUserId and u.jctUserRole.jctRoleId = :userType and u.jctUserSoftDelete = 0 "+
				"and u.jctActiveYn IN (2,3) and u.jctUserDisabled = 0 and sq.jctSurveySoftDelete = 0 and sq.jctSurveyAnswer != 'NOTANSWERED' " +
				"group by sq.jctSurveyTakenByUserId"),	
	@NamedQuery(name = "getSurveyUserIdAndCountForAll",
		query = "Select DISTINCT new com.vmware.jct.dao.dto.SurveyQuestionDTO( COUNT(sq.jctSurveyTakenByUserId), sq.jctSurveyTakenByUserId) " +
				"from JctSurveyQuestions sq, JctUser u "+
				"where u.jctUserId = sq.jctSurveyTakenByUserId and u.jctUserRole.jctRoleId IN (1,3) and u.jctUserSoftDelete = 0 "+
				"and u.jctActiveYn IN (2,3) and u.jctUserDisabled = 0 and sq.jctSurveySoftDelete = 0 and sq.jctSurveyAnswer != 'NOTANSWERED' " +
				"group by sq.jctSurveyTakenByUserId")	
})
@Entity
