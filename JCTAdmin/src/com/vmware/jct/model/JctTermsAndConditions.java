...
@NamedQueries({
	@NamedQuery(name = "fetchTcByProfileId",
				query = "from JctTermsAndConditions where jctUserProfile.jctUserProfile = :userProfile and jctTcUserType = :userType and jctTcSoftDelete = 0"),
	@NamedQuery(name = "fetchTnCByProfileId",
				query = "Select jctTcDescription from JctTermsAndConditions where jctUserProfile.jctUserProfile = :userProfile and jctTcUserType = :userType and jctTcSoftDelete = 0")
})
