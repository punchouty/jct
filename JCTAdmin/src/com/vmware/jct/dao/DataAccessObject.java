...
public abstract class DataAccessObject {
	 ...
	 */
	public String save(Object object) throws DAONullException, DAOEntityExistsException,DAOException {
		...
		try {
			...
			logger.error(object.getClass() + " could not be saved as the entity already exists"+exception.getLocalizedMessage());
			throw new DAOException(exception.getLocalizedMessage());
