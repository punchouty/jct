...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`jobcraftingtoolpublicversion` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `jobcraftingtoolpublicversion`;
...
CREATE TABLE `jct_after_sketch_finalpage_details` (
  ...
  `jct_as_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `version` int(11) DEFAULT NULL,
...
CREATE TABLE `jct_app_settings_master` (
  ...
  `jct_app_last_updated_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_before_sketch_details` (
  ...
  `jct_bs_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `version` int(11) DEFAULT NULL,
...
CREATE TABLE `jct_before_sketch_question` (
  ...
  `jct_bs_status_id` int(10) DEFAULT NULL,
  `version` int(11) DEFAULT NULL,
  `jct_ds_created_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_bs_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_bs_lastmodified_by` varchar(50) DEFAULT NULL,
  `jct_bs_created_by` varchar(50) DEFAULT NULL,
  `jct_bs_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `jct_bs_to_as` (
  ...
  `version` int(11) DEFAULT NULL,
  `jct_bs_to_as_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_bs_to_as_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_check_payment_user_details` (
  ...
  `jct_check_payment_check_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `jct_check_payment_created_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_check_payment_modified_by` varchar(50) DEFAULT NULL,
  `jct_check_payment_modified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_completion_status` (
  ...
  `jct_start_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_end_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_email_details` (
  ...
  `jct_mail_dispatched` int(1) NOT NULL DEFAULT '0',
  `jct_account_created_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_account_created_by` varchar(50) NOT NULL,
  `jct_mail_sent_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_facilitator_details` (
  ...
  `jct_fac_subscribe_limit` int(11) NOT NULL DEFAULT '0',
  `jct_fac_type` varchar(10) NOT NULL,
  `jct_fac_subscription_dt` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_fac_created_by` varchar(100) NOT NULL,
  `jct_fac_created_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_functions` (
  ...
  `jct_functions_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `version` int(11) DEFAULT NULL,
  `jct_ds_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_bs_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_bs_lastmodified_by` varchar(50) DEFAULT NULL,
...
CREATE TABLE `jct_global_profile_history` (
  ...
  `jct_global_profile_created_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_global_profile_bs_main_qtn` varchar(1000) DEFAULT NULL,
  `jct_global_profile_ap_main_qtn` varchar(1000) DEFAULT NULL,
  `jct_global_profile_is_attribute` varchar(4) NOT NULL DEFAULT 'N',
...
CREATE TABLE `jct_instruction_bar` (
  ...
  `version` int(11) DEFAULT NULL,
  `jct_instruction_bar_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `jct_instruction_bar_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_job_attribute` (
  ...
  `version` int(11) DEFAULT NULL,
  `jct_job_attribute_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `jct_job_attribute_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_job_attribute_frozen` (
  ...
  `jct_job_attribute_order` int(11) DEFAULT NULL,
  `jct_job_attribute_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `jct_job_attribute_created_by` varchar(50) DEFAULT NULL,
  `jct_job_attribute_created_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_job_attribute_modified_by` varchar(50) DEFAULT NULL,
  `jct_job_attribute_modified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_levels` (
  ...
  `jct_levels_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `version` int(11) DEFAULT NULL,
  `jct_ds_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_bs_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_bs_lastmodified_by` varchar(50) DEFAULT NULL,
...
CREATE TABLE `jct_onet_occupation_list` (
  ...
  `jct_onet_occupation_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `jct_payment_details` (
  ...
  `jct_pmt_dtls_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `jct_pmt_dtls_created_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_pmt_dtls_modified_by` varchar(100) DEFAULT NULL,
  `jct_pmt_dtls_modified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_pmt_dtls_soft_delete` int(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `jct_payment_header` (
  ...
  `jct_pmt_hdr_total_amt` double NOT NULL DEFAULT '0',
...
CREATE TABLE `jct_pdf_records` (
  ...
  `jct_created_timestamp` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_popup_instruction` (
  ...
  `jct_popup_instruction_creation_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_popup_instruction_last_updation_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_questions` (
  ...
  `jct_questions_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `version` int(11) DEFAULT NULL,
  `jct_ds_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_bs_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_bs_lastmodified_by` varchar(50) DEFAULT NULL,
...
CREATE TABLE `jct_region` (
  ...
  `jct_region_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `version` int(11) DEFAULT NULL,
  `jct_ds_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_bs_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_bs_lastmodified_by` varchar(50) DEFAULT NULL,
...
CREATE TABLE `jct_status_search` (
  ...
  `jct_status_id` int(11) DEFAULT NULL,
  `jct_soft_delete` tinyint(1) NOT NULL DEFAULT '0',
  `version` int(11) DEFAULT NULL,
  `jct_created_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_lastmodified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_lastmodified_by` varchar(50) DEFAULT NULL,
  `jct_created_by` varchar(50) DEFAULT NULL,
  `jct_user_levels` varchar(50) DEFAULT NULL,
  `jct_is_inactive` int(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `jct_survey_question_master` (
  ...
  `jct_survey_qtn_master_soft_del` tinyint(11) NOT NULL DEFAULT '0',
  `jct_survey_qtn_master_created_by` varchar(50) DEFAULT NULL,
  `jct_survey_qtn_master_created_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `jct_survey_qtn_master_modified_by` varchar(50) DEFAULT NULL,
  `jct_survey_qtn_master_modified_ts` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_survey_questions` (
  ...
  `jct_survey_created_ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_survey_soft_delete` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `jct_terms_and_condition` (
  ...
  `jct_tc_created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `jct_tc_modified_by` varchar(255) DEFAULT NULL,
  `jct_tc_modified_on` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `jct_user` (
  ...
  `jct_user_disp_identifier` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `jct_user_details` (
  ...
  `jct_user_details_soft_delete` int(11) NOT NULL DEFAULT '0',
  `jct_user_onet_occupation` varchar(100) NOT NULL DEFAULT 'NOT-ACTIVATED',
...
CREATE TABLE `jct_user_group` (
  ...
  `jct_user_profile` int(11) NOT NULL,
  `jct_user_profile_desc` varchar(50) DEFAULT NULL,
  `jct_active_status` int(11) NOT NULL DEFAULT '1',
  `jct_user_group_desc` varchar(50) DEFAULT NULL,
  `jct_user_customer_id` varchar(200) DEFAULT NULL,
...
CREATE TABLE `jct_user_login_info` (
  ...
  `jct_jobref_no` varchar(50) DEFAULT NULL,
  `jct_user_id` int(11) NOT NULL,
  `jct_start_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  ...
  `jct_as_lastmodified_by` varchar(50) DEFAULT NULL,
  `jct_as_created_by` varchar(50) DEFAULT NULL,
  `jct_completed` int(11) NOT NULL DEFAULT '0',
...
/* Function  structure for function  `BeforeSketch_To_AfterSketch` */

/*!50003 DROP FUNCTION IF EXISTS `BeforeSketch_To_AfterSketch` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `BeforeSketch_To_AfterSketch`(jobRefNo Varchar(30)) RETURNS int(11)
BEGIN
                ...
                cursor_loop: LOOP
					...
					/*elseif((l_jct_bs_task_desc=l_jct_as_task_desc) and (l_jct_bs_energy=l_jct_as_energy)) then 
							...
							insert  into jct_bs_to_as (`jct_bs_to_as_id`,`jct_jobref_no`,`jct_task_id`,`jct_bs_energy`,`jct_bs_time`,`jct_bs_task_desc`,`jct_as_energy`,`jct_as_time`,`jct_as_task_desc`,`jct_diff_status`,`jct_diff_energy`,`jct_diff_time`,`jct_diff_task_desc`,`version`,`jct_bs_to_as_created_by`) 
									Values ( generateId ('jct_bs_to_as'),l_jobRefNo,l_jct_as_task_id,l_jct_bs_energy,'0',l_jct_bs_task_desc,l_jct_as_energy,'0',l_jct_as_task_desc,'Modified Task',diff_energy,'0',diff_desc,0,l_createdBy);
							LEAVE inner_cursor_loop;
					else 
							SET diff_energy=l_jct_bs_energy-l_jct_as_energy;
							SET l_length= locate('(', l_jct_as_task_desc);
...
/* Function  structure for function  `deleteUsers` */

/*!50003 DROP FUNCTION IF EXISTS `deleteUsers` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `deleteUsers`(user_id int) RETURNS int(11)
BEGIN
	DECLARE l_return INT DEFAULT  0;
...
/*!50003 CREATE DEFINER=`root`@`127.0.0.1` FUNCTION `generateId`(idName Varchar(50)) RETURNS int(11)
BEGIN
...
/* Function  structure for function  `global_profile_change_mapping_attrs` */

/*!50003 DROP FUNCTION IF EXISTS `global_profile_change_mapping_attrs` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`127.0.0.1` FUNCTION `global_profile_change_mapping_attrs`(mappingType varchar(10),existingVal Varchar(9999), newVal Varchar(9999), existingDesc varchar(9999), newDesc varchar(9999)) RETURNS varchar(1100) CHARSET utf8
BEGIN
...
/* Function  structure for function  `global_profile_change_question` */

/*!50003 DROP FUNCTION IF EXISTS `global_profile_change_question` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`127.0.0.1` FUNCTION `global_profile_change_question`(pageCode varchar(10),mainQuestion Varchar(200), existingSubQtn varchar(200), newSubQtn varchar(200) ) RETURNS varchar(100) CHARSET utf8
BEGIN   
                DECLARE done INTEGER DEFAULT 0;
...
/* Function  structure for function  `newDiagram` */

/*!50003 DROP FUNCTION IF EXISTS `newDiagram` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`127.0.0.1` FUNCTION `newDiagram`(jobFerNo Varchar(50),decision Varchar(1)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
...
/* Function  structure for function  `populateAfterSketch` */

/*!50003 DROP FUNCTION IF EXISTS `populateAfterSketch` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`127.0.0.1` FUNCTION `populateAfterSketch`(jobFerNo Varchar(50)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
	DECLARE l_jobRefNo Varchar(50);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
	DECLARE l_return INT DEFAULT  0; 
	DECLARE l_status INT DEFAULT  5; 
...
/*jct_action_plan*/
	...
	END; 
	set l_jobRefNo=jobFerNo;
	-- set l_jct_as_header_id=generateId ('jct_after_sketch_header_id');
...
/* Function  structure for function  `populateBeforeSketch` */

/*!50003 DROP FUNCTION IF EXISTS `populateBeforeSketch` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`127.0.0.1` FUNCTION `populateBeforeSketch`(jobFerNo Varchar(50)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                DECLARE l_jobRefNo Varchar(50);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
                DECLARE l_return INT DEFAULT  0; 
                DECLARE l_status INT DEFAULT  5; 
		...
		DECLARE l_jct_bsq_user_id int(11);
                ...
                END; 
                set l_jobRefNo=jobFerNo;
                -- set l_jct_bs_header_id=generateId ('jct_before_sketch_header_id');
...
/* Function  structure for function  `updateStatus` */

/*!50003 DROP FUNCTION IF EXISTS `updateStatus` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`127.0.0.1` FUNCTION `updateStatus`(jobFerNo Varchar(50),decision char(1)) RETURNS int(11)
BEGIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                DECLARE l_jobRefNo Varchar(50);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
                DECLARE l_return INT DEFAULT  0; 
                DECLARE l_status INT DEFAULT  5; 
				...
				SELECT count(jct_status_search_id) into l_count FROM jct_status_search where jct_jobref_no = jobFerNo;
                                ...
                                IF (l_decision='C') THEN  
                                              ...
                                              --  Insert into jct_status_search (`jct_status_search_id`,`jct_jobref_no`,`jct_as_snapshot`,`jct_bs_snapshot`,`jct_bs_snapshot_string`,`jct_as_snapshot_string`,`jct_status_id`,`jct_soft_delete`,`version`,`jct_user_levels`)
                                                  --              values ( generateId ('jct_status_id'),l_jobRefNo,l_jct_as_finalpage_snapshot,l_jct_bs_snapshot,l_jct_bs_snapshot_string,l_jct_as_finalpage_snapshot_string,'5','0','0',l_jct_bs_user_job_title);
...
/* Function  structure for function  `update_facilitator_type_after_chk_realization` */

/*!50003 DROP FUNCTION IF EXISTS `update_facilitator_type_after_chk_realization` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `update_facilitator_type_after_chk_realization`(headerId int(11), customerId Varchar(100), createdBy Varchar(100)) RETURNS int(11)
BEGIN
                DECLARE l_return INT DEFAULT  0;
...
/* Procedure structure for procedure `BeforeSketch_To_AfterSketch` */

/*!50003 DROP PROCEDURE IF EXISTS  `BeforeSketch_To_AfterSketch` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`127.0.0.1` PROCEDURE `BeforeSketch_To_AfterSketch`(IN jobRefNo Varchar(30))
BEGIN
	DECLARE l_jobRefNo Varchar(30);
	DECLARE l_jct_bs_task_id Int;
	DECLARE l_jct_bs_energy Int;
	...
	cursor_loop: LOOP
		...
		if((l_jct_bs_task_id=l_jct_as_task_id) and (l_jct_bs_energy=l_jct_as_energy) and 
			...
			SET diff_desc= substring(l_jct_as_task_desc, l_length);
			 insert  into jct_bs_to_as (`jct_bs_to_as_id`,`jct_jobref_no`,`jct_task_id`,`jct_bs_energy`,`jct_bs_time`,`jct_bs_task_desc`,`jct_as_energy`,`jct_as_time`,`jct_as_task_desc`,`jct_diff_status`,`jct_diff_energy`,`jct_diff_time`,`jct_diff_task_desc`,`version`) 
				Values ( generateId ('jct_bs_to_as'),l_jobRefNo,l_jct_as_task_id,l_jct_bs_energy,'0',l_jct_bs_task_desc,l_jct_as_energy,'0',l_jct_as_task_desc,'No Change',diff_energy,'0',diff_desc,0);
			LEAVE inner_cursor_loop;			
		elseif( (l_jct_bs_task_id=l_jct_as_task_id) and  (l_jct_bs_task_desc=l_jct_as_task_desc)) then 
			SET diff_energy=l_jct_bs_energy-l_jct_as_energy;
			SET l_length= locate('(', l_jct_as_task_desc);
			SET diff_desc= substring(l_jct_as_task_desc, l_length);
			 insert  into jct_bs_to_as (`jct_bs_to_as_id`,`jct_jobref_no`,`jct_task_id`,`jct_bs_energy`,`jct_bs_time`,`jct_bs_task_desc`,`jct_as_energy`,`jct_as_time`,`jct_as_task_desc`,`jct_diff_status`,`jct_diff_energy`,`jct_diff_time`,`jct_diff_task_desc`,`version`) 
				Values ( generateId ('jct_bs_to_as'),l_jobRefNo,l_jct_as_task_id,l_jct_bs_energy,'0',l_jct_bs_task_desc,l_jct_as_energy,'0',l_jct_as_task_desc,'Modifide Task',diff_energy,'0',diff_desc,0);
			LEAVE inner_cursor_loop;
		elseif((l_jct_bs_task_id=l_jct_as_task_id) and (l_jct_bs_energy=l_jct_as_energy)) then 
			SET diff_energy=l_jct_bs_energy-l_jct_as_energy;
			SET l_length= locate('(', l_jct_as_task_desc);
		...
		IF (innerLoopCount=0) THEN
		insert  into jct_bs_to_as (`jct_bs_to_as_id`,`jct_jobref_no`,`jct_task_id`,`jct_bs_energy`,`jct_bs_time`,`jct_bs_task_desc`,`jct_as_energy`,`jct_as_time`,`jct_as_task_desc`,`jct_diff_status`,`jct_diff_energy`,`jct_diff_time`,`jct_diff_task_desc`,`version`) 
				Values ( generateId ('jct_bs_to_as'),l_jobRefNo,l_jct_bs_task_id,l_jct_bs_energy,'0',l_jct_bs_task_desc,l_jct_as_energy,'0',l_jct_as_task_desc,'Deleted Task',diff_energy,'0',diff_desc,0);
		else
			set innerLoopCount=0;
		END IF;
...
select 'aaaaa';
		IF (innerLoopCountTo=0) THEN
		insert  into jct_bs_to_as (`jct_bs_to_as_id`,`jct_jobref_no`,`jct_task_id`,`jct_bs_energy`,`jct_bs_time`,`jct_bs_task_desc`,`jct_as_energy`,`jct_as_time`,`jct_as_task_desc`,`jct_diff_status`,`jct_diff_energy`,`jct_diff_time`,`jct_diff_task_desc`,`version`) 
				Values ( generateId ('jct_bs_to_as'),l_jobRefNo,ll_jct_as_task_id,'','0','',ll_jct_as_energy,'0',ll_jct_as_task_desc,'New Task','','0','',0);
		else
			set innerLoopCountTo=0;
		END IF;
...
/*!50003 CREATE DEFINER=`root`@`%` PROCEDURE `createUser`(userNo INT(10), userType INT(1))
BEGIN
...
/*Table structure for table `actionplanview` */

DROP TABLE IF EXISTS `actionplanview`;

/*!50001 DROP VIEW IF EXISTS `actionplanview` */;
/*!50001 DROP TABLE IF EXISTS `actionplanview` */;

/*!50001 CREATE TABLE  `actionplanview`(
...
/*Table structure for table `aftersketchview` */

DROP TABLE IF EXISTS `aftersketchview`;

/*!50001 DROP VIEW IF EXISTS `aftersketchview` */;
/*!50001 DROP TABLE IF EXISTS `aftersketchview` */;

/*!50001 CREATE TABLE  `aftersketchview`(
 `jct_user_function_group` varchar(50) ,
 `jct_user_occupation` varchar(100) ,
 `jct_user_tenure` varchar(20) ,
 `jct_user_levels` varchar(50) ,
...
/*Table structure for table `beforesketchtoaftersketchview` */

DROP TABLE IF EXISTS `beforesketchtoaftersketchview`;

/*!50001 DROP VIEW IF EXISTS `beforesketchtoaftersketchview` */;
/*!50001 DROP TABLE IF EXISTS `beforesketchtoaftersketchview` */;

/*!50001 CREATE TABLE  `beforesketchtoaftersketchview`(
...
/*Table structure for table `beforesketchview` */

DROP TABLE IF EXISTS `beforesketchview`;

/*!50001 DROP VIEW IF EXISTS `beforesketchview` */;
/*!50001 DROP TABLE IF EXISTS `beforesketchview` */;

/*!50001 CREATE TABLE  `beforesketchview`(
