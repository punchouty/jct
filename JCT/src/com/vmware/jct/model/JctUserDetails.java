...
public class JctUserDetails implements Serializable {
	...
	@Column(name="jct_user_onet_occupation")
	private String jctUserOnetOccupation;
	
	@Column(name="jct_nos_of_years")
	...
	public String getJctUserOnetOccupation() {
		return jctUserOnetOccupation;
	}

	public void setJctUserOnetOccupation(String jctUserOnetOccupation) {
		this.jctUserOnetOccupation = jctUserOnetOccupation;
	}
