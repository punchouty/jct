...
/**/
@NamedQueries({
	@NamedQuery(name = "fetchPopUpType",
				query = "select jct.jctPopupInstructionType " +
						"from JctPopupInstruction jct " +
						"where " +
						"jct.jctPopupInstructionSoftDelete = 0 and " +
						"jct.jctPopupInstructionPage = :relatedPage and " +
						"jct.jctPopupInstructionProfileId = :profileId "),
	@NamedQuery(name = "fetchTextPopUpInstruction",
				query = "from  JctPopupInstruction jct where jct.jctPopupInstructionType =:text " +
						"and jct.jctPopupInstructionSoftDelete = 0 and jct.jctPopupInstructionPage = :relatedPage " +
						"and jct.jctPopupInstructionProfileId = :profileId"),	
	@NamedQuery(name = "fetchVideoPopUpInstruction",
	query = "from  JctPopupInstruction jct where jct.jctPopupInstructionType =:video " +
			"and jct.jctPopupInstructionSoftDelete = 0 and jct.jctPopupInstructionPage = :relatedPage " +
			"and jct.jctPopupInstructionProfileId = :profileId")		
