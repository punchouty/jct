...
/**
 * 
 * <p><b>Class name:</b> JctBeforeSketchDetail.java</p>
 * <p><b>Author:</b> InterraIt</p>
 * <p><b>Description:</b>  This class basically object reference of jct_before_sketch_details table </p>
 ...
 */
@NamedQueries({
	@NamedQuery(name = "deleteDummyBSChildData", 
				query = "DELETE FROM JctBeforeSketchDetail dtl where dtl.jctBsJobrefNo = :jrNo")
})

@Entity
@Table(name="jct_before_sketch_details")
public class JctBeforeSketchDetail implements Serializable {
	...
	private JctBeforeSketchHeader jctBeforeSketchHeader;
	...
	public JctBeforeSketchHeader getJctBeforeSketchHeader() {
		return this.jctBeforeSketchHeader;
	}

	public void setJctBeforeSketchHeader(JctBeforeSketchHeader jctBeforeSketchHeader) {
