...
@NamedQueries({
	@NamedQuery(name = "getAllActiveOccupationList",
				query = "Select new com.vmware.jct.dao.dto.OccupationListDTO(jctOnetOccupation.jctOnetOccupationCode, " +
						...
						+ "OR jctOnetOccupation.jctOnetOccupationDesc LIKE :searchString1 "
						+ "OR jctOnetOccupation.jctOnetOccupationDesc LIKE :searchString2 "
						+ "OR jctOnetOccupation.jctOnetOccupationDesc LIKE :searchString3 "
						+ "OR jctOnetOccupation.jctOnetOccupationDesc LIKE :searchString4 "
						+ "AND jctOnetOccupationSoftDelete = 0"),
	@NamedQuery(name="getOnetDescList",
				query = "from JctOnetOccupationList jctOnetOccupation " +
						"where jctOnetOccupation.jctOnetOccupationTitle = :searchString"),
	@NamedQuery(name="getOnetCodeByDesc",
				query = "select jctOnetOccupation.jctOnetOccupationCode from JctOnetOccupationList jctOnetOccupation " +
						"where jctOnetOccupation.jctOnetOccupationTitle = :searchString and jctOnetOccupation.jctOnetOccupationSoftDelete = 0"),
	@NamedQuery(name="getOccupationDesc",
				query = "select jctOnetOccupation.jctOnetOccupationTitle from JctOnetOccupationList jctOnetOccupation " +
				"where jctOnetOccupation.jctOnetOccupationCode = :onetTitle and jctOnetOccupation.jctOnetOccupationSoftDelete = 0"),
	@NamedQuery(name = "getOnetCodeByTitle",
				query = "Select new com.vmware.jct.dao.dto.OccupationListDTO(jctOnetOccupation.jctOnetOccupationCode, " +
						"jctOnetOccupation.jctOnetOccupationTitle, jctOnetOccupation.jctOnetOccupationDesc) " +
						"from JctOnetOccupationList jctOnetOccupation where jctOnetOccupation.jctOnetOccupationTitle = :searchString and jctOnetOccupationSoftDelete = 0")
})
