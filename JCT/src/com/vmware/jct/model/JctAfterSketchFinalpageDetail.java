...
/**
 * 
 * <p><b>Class name:</b> JctAfterSketchFinalpageDetail.java</p>
 ...
 */
@NamedQueries({
	@NamedQuery(name="findASFinalPageChildren",
				query="from JctAfterSketchFinalpageDetail where jctAsJobrefNo = :refNo and jctAsSoftDelete = 0"),
	@NamedQuery(name="findASFinalPageChildrenDescOrder",
				query="from JctAfterSketchFinalpageDetail where jctAsJobrefNo = :refNo and " +
						"jctAsSoftDelete = 0 order by jctAsTaskEnergy DESC"),
	@NamedQuery(name="findASDistinctRoleFrames",
				query="Select distinct dtl.jctAsRoleDesc from JctAfterSketchFinalpageDetail dtl " +
						"where jctAsJobrefNo = :refNo and jctAsSoftDelete = 0"),
	@NamedQuery(name="deleteAllASPageTwoData", 
				query="DELETE FROM JctAfterSketchFinalpageDetail dtl where dtl.jctAsJobrefNo = :jrNo"),
	@NamedQuery(name="getDistinctRoleName",
				query="SELECT DISTINCT(obj.jctAsRoleDesc) from JctAfterSketchFinalpageDetail obj where "
						+ "obj.jctAsJobrefNo = :jobRefNo and obj.jctAsTaskDesc = :taskDesc and obj.jctAsSoftDelete = 0")			
	
})
@Entity
@Table(name="jct_after_sketch_finalpage_details")
public class JctAfterSketchFinalpageDetail implements Serializable {
	...
	public JctAfterSketchFinalpageDetail() {
	}
