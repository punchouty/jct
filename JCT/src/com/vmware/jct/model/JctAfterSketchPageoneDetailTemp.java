...
/**
 * 
 * <p><b>Class name:</b> JctAfterSketchPageoneDetailTemp.java</p>
 ...
 */
@NamedQueries({
	@NamedQuery(name="deleteAllASPageOneTempData", 
			query = "DELETE FROM JctAfterSketchPageoneDetailTemp pon where pon.jctAsJobrefNo = :jrNo")
})
@Entity
@Table(name="jct_after_sketch_pageone_details_temp")
public class JctAfterSketchPageoneDetailTemp implements Serializable {
	...
	public JctAfterSketchPageoneDetailTemp() {
	}
