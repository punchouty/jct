	                    ...
	                    <div class="form_area_top col-md-12 prev_nxt_sec">
	                        <div class="col-md-2 col-xs-3 Prev_btn_area">
		                  	...
		                  	<div class="col-md-8 col-xs-12 text-center heading-title">
		                    	<spring:message code="label.editBeforeSketchHeader"/>
		                    </div>
		                  	<div class="col-md-2 col-xs-3 Next_btn_area">
		                  		<a href="#" onclick="goToNextPage()" class="btn btn-info prev-btn pull-right"><spring:message code="label.editAfterSketchBtn"/> <span class="glyphicon glyphicon-chevron-right"></span></a>
		                  	</div>
		                  	<div class="clearfix"></div>
	               		</div>
